...
class CronExpression {
    ...
    includesDate(date) {
        ...
        const dt = luxon_1.DateTime.fromISO(date.toISOString(), { zone: this.#tz });
        return (dayOfMonth.values.includes(dt.day) &&
            dayOfWeek.values.includes(dt.weekday) &&
            month.values.includes(dt.month) &&
            hour.values.includes(dt.hour) &&
            minute.values.includes(dt.minute) &&
            second.values.includes(dt.second));
    }
    /**
